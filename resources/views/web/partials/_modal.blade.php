    ...
    <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
        ...
        <div class="offcanvas-body large">
            <ul class="list-unstyled">
                <li class="d-flex"><img src="{{ asset('images/mobile/facebook.png') }}" alt="Nhắn tin qua Facebook" class="img-fluid"><a href="{{ $setting['link_mess_facebook'] }}" target="_blank">Nhắn tin qua Facebook <span>{{ $setting['link_mess_facebook'] }}</span></a></li>
