...
class BannerDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('active', function ($q) {
                ...
                $status = $q->active === Banner::STATUS_ACTIVE ? 'checked' : null;
            ...
            ->addColumn('action', function ($q) {
                ...
                $lowerModelName = strtolower(class_basename(new Banner()));
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('ordering')->title(trans('form.banner.ordering')),
            Column::make('link_page')->title(trans('form.banner.link_page')),
