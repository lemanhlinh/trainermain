...
class CourseDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('active', function ($q) {
                $url = route('admin.course.changeActive', $q->id);
                $status = $q->active === Course::STATUS_ACTIVE ? 'checked' : null;
            ...
            ->addColumn('action', function ($q) {
                $urlEdit = route('admin.course.edit', $q->id);
                $urlDelete = route('admin.course.destroy', $q->id);
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('id'),
            Column::make('title')->title(trans('form.course.title')),
            Column::make('image')->title(trans('form.course.image'))->render([
                'renderImage(data)'
            ]),
            Column::make('active')->title(trans('form.course.active')),
