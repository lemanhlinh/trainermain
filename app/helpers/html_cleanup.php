...
class HtmlCleanup{
	//Các tag cho phép
	var $valid_elements	= array ("section", "a", "b", "blockquote", "br", "center", "del", "div", "em", "embed", "font", "h2", "h3", "h4", "i", "img", "ins", "li", "hr", "ol","object",
	...
	var $extended_valid_elements = array("a"				=> array("href", "name", "rel","target", "title"),
													 "b"				=> array(),
													 "blockquote"	=> array( "title"),
													 "br"				=> array("title"),
													 "center"		=> array(),
													 "del"			=> array("title"),
													 "div"			=> array("align", "title"),
													 "em"				=> array("title"),
													 "embed"			=>	array("src", "quality", "wmode", "name", "type", "pluginspage"),
													 "font"			=> array("color", "title"),
													 "h2"				=> array(),
													 "h3"				=> array(),
													 "h4"				=> array(),
													 "i"				=> array("title"),
													 "img"			=> array("align", "alt", "border", "hspace", "idata", "src", "title", "vspace"),
													 "ins"			=> array("title"),
													 "li"				=> array("title", "type"),
													 "hr"				=> array("align", "noshade", "size", "title"),
													 "ol"				=> array("title", "type"),
													 "object"		=>	array(),
													 "p"				=> array("align", "title"),
													 "pre"			=> array("title"),
													 ...
													 "sub"			=> array("title"),
													 "sup"			=> array("title"),
													 "table"			=> array("align", "bgcolor", "border", "bordercolor", "cellpadding", "cellspacing", "title"),
													 "tbody"			=> array(),
													 "td"				=> array("align", "bgcolor", "colspan", "nowrap", "rowspan", "title", "valign"),
													 "th"				=> array("align", "bgcolor", "colspan", "nowrap", "rowspan", "title", "valign"),
													 "tr"				=> array("align", "bgcolor",  "nowrap", "title", "valign"),
													 "u"				=> array("title"),
													 "ul"				=> array("title", "type"),
													 );
